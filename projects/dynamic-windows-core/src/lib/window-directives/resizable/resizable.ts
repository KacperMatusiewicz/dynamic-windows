...
export class Resizable {
  ...
  private anchorSize: string = "10";

  private element: HTMLElement;

  private topHandle: HTMLElement | undefined;
  private leftHandle: HTMLElement | undefined;
  private rightHandle: HTMLElement | undefined;
  private bottomHandle: HTMLElement | undefined;
  private topLeftHandle: HTMLElement | undefined;
  private topRightHandle: HTMLElement | undefined;
  private bottomLeftHandle: HTMLElement | undefined;
  private bottomRightHandle: HTMLElement | undefined;

  private resizingMethod: any;
  ...
  setAnchorSize(anchorSize: string) {
    this.anchorSize = anchorSize;
  };

  resizableAfterViewInit(): void {
